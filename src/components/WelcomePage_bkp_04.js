...
import CognitiveFrameworkBuilder from './CognitiveFrameworkBuilder';
import ContentSection from './ContentSection';
import ProblemHierarchyBuilder from "./ProblemHierarchyBuilder";
...
const WelcomePage = () => {
  ...
  const handleIndustryChange = async (industryId) => {
    ...
    try {
      ...
      // const url = `http://localhost:5002/api/cognitive-frameworks/domains/${industryId}/strategies`;
      ...
      if (data.success) {
        // Create a domain object with strategies included for the new component
        const domainWithStrategies = {
          ...data.domain,
          strategies: data.strategies
        };
        setSelectedIndustry(domainWithStrategies);
      }
    } catch (error) {
  ...
  return (
    <div className={styles.container}>
      ...
      {/*<CognitiveFrameworkBuilder*/}
      {/*  domainId={currentIndustryId}*/}
      {/*  selectedDomain={selectedIndustry}*/}
      {/*/>*/}

      <ProblemHierarchyBuilder
