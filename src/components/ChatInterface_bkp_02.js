...
// Main Chat Area
const ChatArea = ({ selectedModel, messages, onSendMessage, isLoading, availableModels, currentUser }) => {
...
export default function ChatInterface() {
  ...
  return (
    <div className={styles.chatInterface}>
      ...
      <ProfileNavBar onBackToApp={handleBackToChat} userProfile={currentUser} />
