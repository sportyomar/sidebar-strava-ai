          ...
          <div className={styles.document}>
            {!selectedDoc && !showCreationForm ? (
              ...
              <div className={styles.documentContent}>
                {/* Sticky Header - now disabled in editor mode */}
                <div className={`${styles.stickyHeader} ${showStickyHeader && documentMode !== 'editor' ? styles.visible : ''}`}>
                ...
                <header className={styles.documentHeader} ref={documentHeaderRef}>
                  <div className={styles.headerContent}>
                    ...
                    {/* Edit Details Button */}
                    {isAuthenticated && user && selectedDoc.created_by === JSON.parse(localStorage.getItem('user')).id && documentMode === 'editor' && (
                      <button
