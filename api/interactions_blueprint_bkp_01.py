...
# Add these endpoints to your interactions_api.py file (move to another blueprint)

# @interactions_api.route('/api/interactions/intents/rules/<int:workspace_id>', methods=['GET'])
...
#
#
# @interactions_api.route('/api/interactions/intents/rules', methods=['POST'])
...
#
#
# @interactions_api.route('/api/interactions/intents/rules/<int:workspace_id>/<intent_name>', methods=['DELETE'])
...
#
#
# @interactions_api.route('/api/interactions/intents/rules/bulk-update', methods=['POST'])
...
#
#
# @interactions_api.route('/api/interactions/intents/rules/validate', methods=['POST'])
...
#
#
# @interactions_api.route('/api/interactions/intents/rules/export/<int:workspace_id>', methods=['GET'])
...
#
#
# @interactions_api.route('/api/interactions/intents/rules/import/<int:workspace_id>', methods=['POST'])
